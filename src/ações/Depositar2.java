...
public class Depositar2 extends Thread {
    ...
    public Depositar2(Socket conexao, String conta, int valor) {
    ...
    public void executa(){
        try {
            ...
            Thread thread = new Depositar2(socket, conta, valor);
            thread.start();
            saida.println("1 "+ conta + " " + valor);
